...
You are building the public face of **robertobendi/anyo45** (modeled after https://www.facebook.com/anyoatdisenyo). Target: GitHub
...
user can log into the local admin later):
    ...
    ADMIN_PASSWORD="bis-6ntVka4ge-EcpN" \
    ADMIN_NAME="Admin" \
    SITE_NAME="Anyo45" \
